  ...
  return (
    <div className="h100 w100 column center center-alt animated fadeIn">
      ...
      <span className="mb-48">
        <Trans i18nKey="home.register_form.result_success.message">
      ...
      <Button type="button" color="green" variant="secondary" handleClick={handleOk}>{ t('home.register_form.result_success.action') }</Button>
    </div>
  );
}
