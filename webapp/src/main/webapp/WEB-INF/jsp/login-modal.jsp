    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form id="login-form" action='<spring:url value="/login" htmlEscape="true"/>' method="post" >
        ...
        <div class="modal-footer">
          <a href='<spring:url value="/register" htmlEscape="true"/>' role="button" class="btn btn-outline-gumpu"><spring:message code="signup"/></a>
        </div>
      </div>
    </div>
  </div>
